...
class RentalHouseRepository {
  ...
  final List<RentalHouse> _houses = [
    RentalHouse(
      ...
      region: 'Jalisco',
      price: 59,
      imagePath: 'images/casa_roca/casa_roca.png',
      rating: 4.7,
      reviewCount: 2498,
      distance: 80,
      ...
      hostName: 'Juan Pérez',
      hostImagePath: 'images/profile.png',
    ...
    RentalHouse(
      ...
      location: 'La Barrita',
      region: 'Baja Califonia',
      price: 89,
      imagePath: 'images/casa_tortugas/casa_tortugas.png',
      rating: 4.7,
      reviewCount: 1256,
    ...
    RentalHouse(
      ...
      region: 'Jalisco',
      price: 75,
      imagePath: 'images/peace_garden/peace_garden.png',
      rating: 4.5,
      reviewCount: 987,
      distance: 120,
